...
import { deleteMiddle } from "../src/2095-deleteMiddle";
import { arrayToLinkedList } from "../src/utils/arrayToLinkedList";

describe("2095: Delete Middle of The Linked List", () => {
  it("first test", () => {
    const head = arrayToLinkedList([1, 3, 4, 7, 1, 2, 6]);
    const result = arrayToLinkedList([1, 3, 4, 1, 2, 6]);

    const test = deleteMiddle(head);
  ...
  it("second test", () => {
    ...
    const result = arrayToLinkedList([1, 2, 4]);
  ...
  it("third test", () => {
    ...
    const result = arrayToLinkedList([2]);
